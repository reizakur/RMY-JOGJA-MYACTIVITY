...
Future<Database> initilizaeDb() async {
  Future<Database> db = openDatabase(
    ...
    return db.execute(
        'CREATE TABLE SHOPPING_ITEMS(ID INTEGER PRIMARY KEY AUTOINCREMENT, TITLE TEXT, BOUGHT INTEGER, DATE_ADDED TEXT)');
  }, version: 1);
...
Future<void> insertItemsToDb(title, bought) async {
  ...
  await db.transaction((txn) {
    ...
    return txn.rawInsert(
        "INSERT INTO SHOPPING_ITEMS(TITLE, BOUGHT, DATE_ADDED) VALUES('$title', $bought, '$dateAdded')");
  });
